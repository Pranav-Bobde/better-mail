/**
 * Fills process.env with real-shaped test values satisfying the server env
 * schema, including a fake localhost DATABASE_URL so tests can never reach
 * Neon. Call it before importing anything that loads `@code-main/env/server`.
 */
